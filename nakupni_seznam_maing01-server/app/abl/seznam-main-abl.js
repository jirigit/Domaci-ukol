...
const Errors = require("../api/errors/seznam-main-error.js");
...
const logger = LoggerFactory.get("SeznamMainAbl");
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "NakupniSeznam",
        typeCode: "nakupni-seznam-maing01",
        location: location,
...
module.exports = new SeznamMainAbl();
