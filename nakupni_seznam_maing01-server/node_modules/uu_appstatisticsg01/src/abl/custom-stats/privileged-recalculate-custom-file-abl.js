"use strict";
// documentation: https://uuapp.plus4u.net/uu-bookkit-maing01/d11a43aa3a214083b84a4e4103a4f635/book/page?code=51734834
// template:
// templateVersion:
//@@viewOn:revision
...
const Errors = require("../../api/errors/custom-stats-errors").PrivilegedRecalculateCustomFile;
...
class PrivilegedRecalculateCustomFileAbl {
  constructor() {
  ...
  async privilegedRecalculateCustomFile(awid, dtoIn) {
    ...
    const uuAppErrorMap = ValidationHelper.processValidationResult(
      dtoIn,
      validationResult,
      WARNINGS.privilegedRecalculateCustomFile.code,
      Errors.InvalidDtoIn
    );
...
module.exports = new PrivilegedRecalculateCustomFileAbl();
