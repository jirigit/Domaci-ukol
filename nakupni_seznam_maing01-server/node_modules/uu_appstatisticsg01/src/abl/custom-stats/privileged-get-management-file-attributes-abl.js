"use strict";
// documentation: https://uuapp.plus4u.net/uu-bookkit-maing01/d11a43aa3a214083b84a4e4103a4f635/book/page?code=87633679
// template:
// templateVersion:
//@@viewOn:revision
...
class PrivilegedGetManagementFileAttributes {
  constructor() {
  ...
  async privilegedGetManagementFileAttributes(awid, dtoIn) {
    ...
    const uuAppErrorMap = ValidationHelper.processValidationResult(
      dtoIn,
      validationResult,
      WARNINGS.privilegedGetManagementFileAttributes.code,
      Errors.PrivilegedGetManagementFileAttributes.InvalidDtoIn
    );

    // HDS 2
    const binaryStoreBaseUri = Config.get(Constants.binaryStoreBaseUri) || Config.get(Constants.defaultBinaryStore);
    if (!binaryStoreBaseUri) throw new Errors.PrivilegedGetManagementFileAttributes.MissingBinaryStore(uuAppErrorMap);
...
module.exports = new PrivilegedGetManagementFileAttributes();
